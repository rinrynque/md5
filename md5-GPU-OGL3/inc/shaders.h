...
public:
    ...
    void bindAttribsLocations(const std::vector<char*> attribNames/*, std::vector<GLuint> locations = 0*/);
    void linkProgram();
    std::vector<GLuint> getUniformLocations(const std::vector<char*> uniformNames);
    void delShader();
    GLuint getProgramID();
