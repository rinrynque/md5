...
protected:
    ...
    typedef std::vector<glm::vec3> BitangentBuffer;
    ...
    struct Mesh
    {
        ...
        TangentBuffer    m_TangentBuffer;     // Vertex tangent stream
        BitangentBuffer    m_BitangentBuffer;     // Vertex bitangent stream
        ...
        GLuint          m_GLTangentBuffer;
        GLuint          m_GLBitangentBuffer;
